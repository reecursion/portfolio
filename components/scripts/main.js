function toggleDarkMode() {
    ...
    if (isDarkMode) {
        darkModeToggle.setAttribute('fill', '#ffffff');
        ...
        darkModeToggle.setAttribute('fill', '#828282');
        darkModeToggle.style.opacity = '0';
        darkModeToggle.style.transform = 'scale(0.8)';
        darkModeToggle.style.transition = 'opacity 0.3s ease-out, transform 0.3s ease-out';
        setTimeout(() => {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#828282" class="bi bi-moon-fill" viewBox="0 0 16 16">
              <path d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 
                0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 
